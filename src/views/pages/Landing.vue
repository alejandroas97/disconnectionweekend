    ...
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <!-- <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
                <span class="text-900 font-medium text-2xl line-height-3 mr-8">ENHORABUENA, RETO SUPERADO</span>
            </div> -->
            <div
                id="hero"
                class="flex h.10 flex-column pt-4 px-4 lg:px-8 overflow-hidden"
                style="height: 1000px; background: linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), radial-gradient(77.36% 256.97% at 77.36% 57.52%, rgb(238, 239, 175) 0%, rgb(195, 227, 250) 100%); clip-path: ellipse(150% 87% at 93% 13%)"
            >
                <div class="mx-4 md:mx-8 mt-0 md:mt-4">
                    <h1 class="text-6xl font-bold text-gray-900 line-height-2"><span class="font-light block">Enhorabuena!!</span>Has pasado el primer reto</h1>
                    <p class="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Toca en el siguiente enlace para obtener los días del evento.</p>
                    <Button label="Añadir a mi calendario" @click="redirectToAnotherPage" />
                </div>
